    ...
    <section class="flex justify-center items-center mt-18">
        <div class="w-full max-w-6xl">
            ...
            <div class="flex justify-center items-center">
                <form action="{{ isset($item) ? route('item.update', $item->item_id) : route('item.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-4 rounded-lg border space-y-4 w-4xl">
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            @error('item_name') <p class="text-red-500 text-sm">{{ $message }}</p> @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            @error('stocks') <p class="text-red-500 text-sm">{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            @error('item_status') <p class="text-red-500 text-sm">{{ $message }}</p> @enderror
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            @error('sold') <p class="text-red-500 text-sm">{{ $message }}</p> @enderror
                        </div>
                    </div>
