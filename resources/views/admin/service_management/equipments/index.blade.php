    ...
    <section class="flex justify-center items-center mt-18">
        <div class="w-full max-w-6xl px-4 py-4">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-bold text-[#222831] mb-5">Equipments Table</h2>
                <a href="{{ route('equipment.create.form') }}" class="inline-block px-6 py-2 bg-[#222831] text-white text-sm rounded transition">
                    Add New Equipments
                </a>
            </div>
                        ...
                        <div class="overflow-hidden">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @forelse ($equipmentsList as $index => $equipment)
                                        <tr>
                                            ...
                                            <td class="px-6 py-2 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('equipment.show', $equipment) }}" class="text-gray-800 hover:underline px-1">Info</a>
                                                <a href="{{ route('equipment.edit', $equipment) }}" class="text-gray-800 hover:underline px-1">Edit</a>

                                                <button 
                                                    type="button"
                                                    data-hs-overlay="#delete-modal-{{ $equipment->equipment_id }}"
                                                    class="text-red-800 hover:underline px-1">
                                                    Delete
                                                </button>
                                                <div id="delete-modal-{{ $equipment->equipment_id }}" class="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto">
                                                    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-14 opacity-0 transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                                                        <div class="relative flex flex-col bg-white shadow-lg rounded-xl p-6">
                                                            <div class="flex justify-between items-center">
                                                                ...
                                                                <button type="button" class="text-gray-400 hover:text-gray-600" data-hs-overlay="#delete-modal-{{ $equipment->equipment_id }}">
                                                            ...
                                                            <div class="flex justify-end gap-2">
                                                                <button type="button" class="py-2 px-4 text-gray-800 hover:bg-gray-100 rounded-md border border-gray-300" data-hs-overlay="#delete-modal-{{ $equipment->equipment_id }}">
                                                                    Cancel
                                                                </button>
                                                                <form action="{{ route('equipment.delete', $equipment) }}" method="POST">
                                                                    @csrf
                                    ...
                                    @empty
                                        <td colspan="6" class="text-center">No Equipments Available</td>
                                    @endforelse
                                </tbody>
                            </table>
                        </div>
